<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <a href="<?= base_url('product/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add Data Product</a>
            <a href="<?= base_url('product/print') ?>" class="btn btn-info btn-sm"><i class="fa fa-print"></i> Print</a>
            <a href="<?= base_url('product/pdf') ?>" class="btn btn-danger btn-sm"><i class="fa fa-file"></i> Export Pdf</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                    ...
                    <tbody>
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('product/delete/' . $pdt->id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin Menghapus Product Ini?')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                <?php endforeach ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('product/edit/' . $pdt->id) ?>" method="POST">
