...
class Inventaris_pendataan_out extends CI_Controller
{
    ...
    {
        $data['page_title'] = 'Inventaris Pendataan Out';
        $data['inventaris_pendataan_out'] = $this->model_inventaris_out->get_data('stock_out')->result();

        $this->load->view('template/meta', $data);
        $this->load->view('template/navbar', $data);
        $this->load->view('inventaris_pendataan_out', $data);
        $this->load->view('template/footer');
    }

    public function tambah()
    {
        $data['page_title'] = 'Tambah Inventaris';

        $this->load->view('template/meta', $data);
        $this->load->view('template/navbar', $data);
        $this->load->view('tambah_inventaris_out', $data);
        $this->load->view('template/footer');
    }
